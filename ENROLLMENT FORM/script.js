...
const getData = function () {
  ...
  return { name, email, website, image, phoneno, gender, skills };
};
...
function printResult(data) {
  ...
  phoneno.className = "infoText phoneno";
  ...
  textInfoContainer.append(name, gender, email, website, phoneno, skills);
